...
const form = useForm({
    ...
    time_expire_pay: microsite.time_expire_pay,
...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div
            class="mx-auto w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg justify-center">
