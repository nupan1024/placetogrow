...
test('view index users when user is super admin', function () {
...
test('view index users when user has permission', function () {
    PermissionFactory::new()->createMany(Permissions::toArray());

    $role = new Role();
    $role->name = 'Role test';
    $role->syncPermissions([Permissions::USERS->value]);
    $role->save();
...
test('view index users when user does not have permission', function () {
    PermissionFactory::new()->createMany(Permissions::toArray());
