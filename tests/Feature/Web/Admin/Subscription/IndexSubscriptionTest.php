...
test('view index subscription when user is super admin', function () {
...
test('view index subscription when user has permission', function () {
    PermissionFactory::new()->createMany(Permissions::toArray());
...
test('view index subscription when user does not have permission', function () {
    PermissionFactory::new()->createMany(Permissions::toArray());
